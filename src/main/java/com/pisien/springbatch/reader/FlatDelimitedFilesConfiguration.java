...
public class FlatDelimitedFilesConfiguration {
    private final Logger logger = LoggerFactory.getLogger("FlatDelimitedFilesConfiguration 의 로그");
...
//                .processor(itemProcess())
    ...
    public ItemReader itemReader() {
        return new FlatFileItemReaderBuilder<Customer>()
                .name("flateFile")
                .resource(new ClassPathResource("/customer.csv"))   // 읽어올 파일
